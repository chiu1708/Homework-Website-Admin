...
const AddSubject = ({data, functions}) => {
          ...
          books.map((book, index) => {
            return (
              <div key={index} className='book-input-container'>
                ...
                <p><b>Book:</b></p>
                <input onChange={() => handleSetBookField(event, index, "link")} type="text" placeholder='link' />
                <input onChange={() => handleSetBookField(event, index, "name", "vi")} type="text" placeholder='name-vi' />
                <input onChange={() => handleSetBookField(event, index, "name", "en")} type="text" placeholder='name-en' />
